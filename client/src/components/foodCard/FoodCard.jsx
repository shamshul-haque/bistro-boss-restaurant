...
const FoodCard = ({ item }) => {
  ...
  return (
    <div className="bg-gray-200 flex flex-col justify-between items-center mt-6">
      ...
      <button className="bg-gray-300 border-yellow-600 border-b-2 p-2  rounded-lg hover:bg-black transition-all duration-500 hover:border-b-0 text-yellow-600 mb-5">
        Add To Cart
      </button>
    </div>
  );
